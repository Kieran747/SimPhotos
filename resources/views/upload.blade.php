    ...
    <p>Test</p>
        ...
        <form name="upload" action="upload-photo" method="POST" style="width: 550px; float: right;" enctype="multipart/form-data">
            ...
            <div class="upload-details">
                ...
                <p style="margin-left: 10px; font-size: 15px; font-weight: bold; float: left">Airport; if airport does not show</p> <a style="color: blue; position: relative; left: 5px; font-size: 15px; font-weight: bold;" href="/request/airport">Request Add</a> <br>
                <select name="airport" style="position: relative; right: 215px">
