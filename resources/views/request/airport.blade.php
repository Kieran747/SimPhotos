...
@section('content')
    ...
    @guest
        ...
        <div class="container">
            ...
            <p>Request an airport to be added. We try our very best to add ever airport however we might miss a few.</p>
            ...
            <form action="/airport-request" method="POST" name="airport-request">
                ...
                <p>Enter ICAO of airport(4-letter code)</p>
                <input type="text" name="ICAO" style="width: 500px; margin-bottom: 10px;" placeholder="ICAO" maxlength="4"> <br>
                <p>Enter the country the airport is located in</p>
